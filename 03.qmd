...
| Term           | Definition                                                                                                                             |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| **Cytoplasm**  | The material inside a cell that includes the cytosol and all organelles except the nucleus; it is the site of many cellular processes. |
| **Cytosol**    | The fluid portion of the cytoplasm in which organelles and other components are suspended.                                             |
| **Organelles** | Specialized structures within a cell that perform specific functions (e.g., mitochondria, ribosomes, nucleus).                         |


#### Orgarnelle Types:
| Term                             | Definition                                                                                            |
| -------------------------------- | ----------------------------------------------------------------------------------------------------- |
| **Rough Endoplasmic Reticulum**  | Membrane network studded with ribosomes; site of protein synthesis and transport.                     |
| **Smooth Endoplasmic Reticulum** | Membrane network without ribosomes; involved in lipid synthesis, detoxification, and calcium storage. |
| **Golgi apparatus**              | Organelle that modifies, sorts, and packages proteins and lipids for transport.                       |
| **Mitochondrion**                | Organelle that produces ATP (energy) through cellular respiration.                                    |
| **Lysosomes**                    | Vesicles containing digestive enzymes that break down waste and cellular debris.                      |
| **Peroxisomes**                  | Organelles that break down fatty acids and detoxify harmful substances like hydrogen peroxide.        |
| **Microfilaments**               | Thin protein filaments (actin) involved in cell shape, movement, and contraction.                     |
| **Microtubules**                 | Hollow protein tubes that help maintain cell shape, form spindle fibers, and enable transport.        |
| **Cilia**                        | Short, hair-like structures that move fluid across the cell surface.                                  |
| **Flagella**                     | Long whip-like structures used for cell movement.                                                     |
| **Nucleus**                      | Control center of the cell containing DNA and directing cellular activities.                          |
| **Nucleolus**                    | Region inside the nucleus where ribosomes are produced.                                               |

### **Membrane Transport**
Passive Transport: Movement of substances across a membrane without energy (ATP), from high to low concentration.
Active Transport: Movement of substances across a membrane using energy (ATP), often against a concentration gradient.
Diffusion: Movement of molecules from high to low concentration until equilibrium is reached.
Osmosis: Diffusion of water across a selectively permeable membrane.
Cell Cycle: The series of stages a cell goes through to grow and divide.
Interphase: The longest phase of the cell cycle where the cell grows and prepares for division.
Mitosis: Process of nuclear division that produces two genetically identical daughter nuclei.

### **Stages of Interphase and Mitosis**

-  Interphase: Overall growth and preparation phase (G1, S, G2).
G1 phase: Cell grows and carries out normal functions.
S phase: DNA is replicated.
G2 phase: Further growth and preparation for mitosis; organelles and proteins are produced.
...
| --------------- | --------------------------------------------------------------------------------- | ---------------------------------------------- |
| **Prophase**    | Chromatin condenses into chromosomes; nuclear envelope breaks down; spindle forms | Chromosomes become visible, nucleus disappears |
| **Metaphase**   | Chromosomes align at the cell’s equator (metaphase plate)                         | Chromosomes lined up in center                 |
| **Anaphase**    | Sister chromatids separate and move to opposite poles                             | Chromatids pulled apart                        |
| **Telophase**   | Nuclear membranes reform; chromosomes decondense                                  | Two nuclei begin forming                       |
| **Cytokinesis** | Cytoplasm divides                                                                 | Two separate daughter cells form               |
...
| a   |carbohidrate     |
| b   | glycolipid    |
| c   |  periphiral protein   |
| d   | surface protein    |
| e   |  cholestrole   |
| f   |  protein channle   |
| g   |  phospho lipid bi layer   |
...
* **Cytokinesis:** Division of the cytoplasm to form two separate daughter cells after mitosis.
* **Interphase:** The phase of the cell cycle when the cell grows, performs normal functions, and replicates DNA in preparation for division.
* **M-phase:** The mitotic phase of the cell cycle, including mitosis and cytokinesis, where the cell divides.
* **Chromosome:** A tightly coiled structure of DNA and proteins that carries genetic information.
* **Chromatin:** Loosely organized DNA and protein complex found in the nucleus during interphase.


**Mitosis:** The stages and processes of **M-phase (mitosis + cytokinesis)** are:
...
| ---------------------------- | ------------ | ----------------------------------------------------------------------------------------- |
| Plasma membrane              |              | Selectively permeable barrier that controls movement of substances in and out of the cell |
| Cilia                        |              | Hair-like projections that move fluids or particles across the cell surface               |
...
| Nuclear pore                 |              | Allows transport of molecules (like RNA and proteins) between nucleus and cytoplasm       |
| Ribosome                     |              | Site of protein synthesis                                                                 |
| Vesicle                      |              | Small membrane-bound sac for transport and storage of materials                           |
| Peroxisome                   |              | Breaks down fatty acids and detoxifies harmful substances using enzymes                   |
| Lysosome                     |              | Contains digestive enzymes to break down waste, old organelles, and pathogens             |
...
| Smooth endoplasmic reticulum |              | Synthesizes lipids, detoxifies chemicals, and stores calcium                              |
| Centriole                    |              | Helps organize microtubules and forms spindle fibers during cell division                 |
...
The basic structure of a cell's membrane is a phospholipid bilayer with associated proteins that can be either integral (embedded) or peripheral (surface).
...
b) integral proteins
(Ion channels are embedded in the membrane, which defines integral proteins.)
c) ribosomes
(The nucleolus assembles ribosomal subunits.)
d) the water
(Cytosol is the fluid portion, like water in a pool.)
b) ribosomes
(Rough ER looks “rough” because ribosomes are attached to it.)
a) production of proteins
(Rough ER is responsible for synthesizing proteins, especially those for secretion or membranes.)
a) mitochondria
(Mitochondria generate ATP through cellular respiration.)
b) G1
(G1 phase is when the cell grows and prepares for DNA replication.)
...
Interphase → f) The summary of the G1, S, G2 phases
G2 Phase → e) The cell grows a second time to reorganize its contents in preparation for mitosis
Metaphase → i) Occurs when the cell's chromosomes condense and move together, aligning in the center of the dividing cell
S phase → d) Occurs when the cell synthesizes a complete copy of the DNA
Mitosis or M phase → g) The process when the cell separates its DNA into two sets and divides its cytoplasm, forming two new cells
Prophase → a) The first stage of mitosis
G1 phase → c) The cell grows physically larger, making the molecular building blocks it will need in later steps
Cytokinesis → b) The division of the cytoplasm of a cell
Telophase → j) The final stage in cell division
Anaphase → h) Observed when the chromosomes move toward opposite ends of the nuclear spindle
...
**7.** Membrane‑bound organelles involved in lipid metabolism and conversion of hydrogen peroxide *(10)*  

**P E R O X I S O M E S**  
**Answer:** Peroxisomes  
...
**1.** The site in the nucleus where ribosome components are produced and exported *(9)*  
...
**2.** Small structures made of microtubules that exist as part of the centrosome *(9)*  
...
**4.** Organelle that moves molecules from the endoplasmic reticulum to their destination *(5,9)*  
...
**8.** Organelle in the cytoplasm; site of protein synthesis *(8)*  
...
| Name | Description |
|--------------------------|---------------------------------------------|
| 1\) \__ Interphase | a\) The first stage of mitosis |
| 2\) _\_ G2 Phase | b\) The division of the cytoplasm of a cell |
| 3\) \_\\_\_ Metaphase | c\) The cell grows physically larger, making the molecular building blocks it will need in later steps. |
| 4\) \_\\_ S phase | d\) Occurs when the cell synthesizes a complete copy of the DNA. |
| 5\) \_\_\_ Mitosis or M phase | e\) The cell grows a second time to reorganize its contents in preparation for mitosis. |
| 6\) \_\_\_ Prophase | f\) The summary of the G1, S, G2 phases |
| 7\) \_\\_ G1 phase | g\) The process when the cell separates its DNA into two sets and divides its cytoplasm, forming two new cells. |
| 8\) \_\\_ Cytokinesis | h\) Observed when the chromosomes move toward opposite ends of the nuclear spindle |
| 9\) \_\\_ Telophase | i\) Occurs when the cell's chromosomes condense and move together, aligning in the center of the dividing cell. |
| 10\) \__\_ Anaphase | j\) The final stage in cell division |
